...
class Canvas(QtWidgets.QGraphicsScene):
    ...
    def load_image(self, in_file_name):
        ...
        if self.directory == os.path.split(file_name)[0]:
            ...
            bpl = int(imageArray.nbytes / imageArray.shape[0])
            if imageArray.shape[2] == 4:
                ...
                self.qt_image = QtGui.QImage(imageArray.data, imageArray.shape[1], imageArray.shape[0], bpl, QtGui.QImage.Format_RGB888)
